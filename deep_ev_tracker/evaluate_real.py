...
EvalDatasetConfigDict = {
    ...
    EvalDatasetType.EDS: {"dt":0.25, "root_dir": "/media/aircraft-lab/abb843bc-72d2-41f9-a1dd-ed0eedb446d8/DL_Dataset_Fall_2024/Augmented_DS/"},
}
...
def track(cfg):
    ...
    for seq_name, seq_type in EVAL_DATASETS:
        ...
        gt_features_path = "/media/aircraft-lab/abb843bc-72d2-41f9-a1dd-ed0eedb446d8/DL_Dataset_Fall_2024/GT_Tracks/rgb_aligned_town01_night.txt"
